...
def main():
    ...
    # Dataset
    parser.add_argument('--dataset', type=str, choices = ['regression_synth', 'classification_synth', 'MNIST', 'CIFAR10', 'CIFAR10aug', 'tidigits','dvsgesture','timit'], default='tidigits', help='Choice of the dataset: synthetic regression (regression_synth), synthetic classification (classification_synth), MNIST (MNIST), CIFAR-10 (CIFAR10), CIFAR-10 with data augmentation (CIFAR10aug). Synthetic datasets must have been generated previously with synth_dataset_gen.py. Default: MNIST.')
    # Training
    ...
    parser.add_argument('--epochs', type=int, default=1000, help='Number of training epochs Default: 100.')
    ...
    parser.add_argument('--codename', type=str, default='rnntest1-15')
    ...
    parser.add_argument('--lrstep', type=int, default=20, help='lr step-size')
    parser.add_argument('--lrgama', type=float, default=0.8, help='lr gama')
